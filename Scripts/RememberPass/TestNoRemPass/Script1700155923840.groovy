...
// Do not check the "Remember me" checkbox
...
if (username == '' && password == '') {
    println('Test Case Passed: Username and password were not auto-filled.')
} else {
    KeywordUtil.markFailed('Test Case Failed: Username or password was auto-filled.')
}
