...
WebUI.setText(findTestObject('Object Repository/Page_Hasaki.vn  M Phm  Clinic/input_email'), '079234753')
...
if ((isDisabled != null) && isDisabled.equals('true')) {
    println('Test case passed: Nút bị vô hiệu hóa với số điện thoại không hợp lệ')
} else {
    println('Test case failed: Nút không bị vô hiệu hóa với số điện thoại không hợp lệ')
}
